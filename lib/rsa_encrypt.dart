...
class RsaKeyHelper {
  ...
  /// Encode Public key to PEM PKCS8 Format
  ///
  /// Given [RSAPublicKey] returns a base64 encoded [String] with standard PEM PKCS8 headers and footers
  ...
  ///
  /// Given [RSAPrivateKey] returns a base64 encoded [String] with standard PEM PKCS8 headers and footers

  String encodePrivateKeyToPemPKCS8(RSAPrivateKey privateKey) {
    ASN1Integer version = ASN1Integer(BigInt.from(0));

    ASN1Sequence algorithmSeq = new ASN1Sequence();
    ASN1Object algorithmAsn1Obj = new ASN1Object.fromBytes(Uint8List.fromList(
        [0x6, 0x9, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0xd, 0x1, 0x1, 0x1]));
